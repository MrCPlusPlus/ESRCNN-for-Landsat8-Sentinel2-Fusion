...
parser.add_argument('-opt', type=str, default='options/test/test_ESRCNN_S2L8_2.json', help='Path to options JSON file.')
...
data_root_L8 = os.path.join(data_root, 'L8_20170701/testing')
data_root_S2 = os.path.join(data_root, 'S2_20170627/testing')
data_root_S2_2 = os.path.join(data_root, 'S2_20170707/testing')
...
S2_B02_down_2 = m.imresize(S2_B02_2, (S2_B02.shape[0]//3,S2_B02.shape[1]//3), 'bicubic')
S2_B03_2 = io.imread(data_root_S2_2+'/B03.tif',dtype=np.uint8)
S2_B03_down_2 = m.imresize(S2_B03_2, (S2_B02.shape[0]//3,S2_B02.shape[1]//3), 'bicubic')
S2_B04_2 = io.imread(data_root_S2_2+'/B04.tif',dtype=np.uint8)
S2_B04_down_2 = m.imresize(S2_B04_2, (S2_B02.shape[0]//3,S2_B02.shape[1]//3), 'bicubic')
S2_B08_2 = io.imread(data_root_S2_2+'/B08.tif',dtype=np.uint8)
S2_B08_down_2 = m.imresize(S2_B08_2, (S2_B02.shape[0]//3,S2_B02.shape[1]//3), 'bicubic')
S2_B11_2 = io.imread(data_root_S2_2+'/B11_re.tif',dtype=np.uint8)
S2_B11_down_2 = m.imresize(S2_B11_2, (S2_B02.shape[0]//3,S2_B02.shape[1]//3), 'bicubic')
S2_B12_2 = io.imread(data_root_S2_2+'/B12_re.tif',dtype=np.uint8)
S2_B12_down_2 = m.imresize(S2_B12_2, (S2_B02.shape[0]//3,S2_B02.shape[1]//3), 'bicubic')
...
S2_2 = np.stack([S2_B02_down_2,S2_B03_down_2,S2_B04_down_2,S2_B08_down_2,S2_B11_down_2,S2_B12_down_2],axis=2)
S2 = np.concatenate((S2,S2_2),axis=2)
...
save_path=os.path.join(dataset_dir,'S2L8_2_results/testing')
if(not os.path.exists(save_path)):
    os.makedirs(save_path)

io.imsave(os.path.join(save_path,"ESRCNN_S2L8_2.tif"),pred)
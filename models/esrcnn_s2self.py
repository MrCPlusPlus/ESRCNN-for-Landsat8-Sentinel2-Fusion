...
class esrcnn_s2self(BaseModel):
    def __init__(self, opt):
        super(esrcnn_s2self, self).__init__(opt)
        train_opt = opt['train']

        self.net = networks.define_ESRCNN_S2self(opt)
    ...
    def save(self, iter_step):
        self.save_network(self.net, 'ESRCNN_S2self', iter_step)

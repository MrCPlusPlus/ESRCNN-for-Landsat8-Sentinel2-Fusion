...
def crop(L8_root,S2_root,crop_size_h,crop_size_w,prefix,save_dir,crop_label=False):
	...
	raw_S2_B11 = io.imread(S2_root+'/B11_re.tif',dtype=np.uint8)
	raw_S2_B12 = io.imread(S2_root+'/B12_re.tif',dtype=np.uint8)

	raw_L8_7 = [raw_L8_B01, raw_L8_B02, raw_L8_B03, raw_L8_B04, raw_L8_B05, raw_L8_B06, raw_L8_B07]
	raw_S2 = [raw_S2_B02, raw_S2_B03, raw_S2_B04, raw_S2_B08, raw_S2_B11, raw_S2_B12]
	...
	while(y2<h_L8 and y2*3<h_S2):
		while(x2<w_L8 and x2*3<w_S2):
			...
			io.imsave(os.path.join(save_dir,'S2_1',prefix+"_%d.tif"%(index)),patch_S2)
